...
<div class="d-flex align-items-center">
    ...
    <form action="{{ route('users.destroy', $model->id) }}" method="POST" style="display: inline;">
        @csrf
        @method('DELETE')
        <button type="button" class="btn btn-sm btn-danger me-2 btn-delete" data-id="{{ $model->id }}">
